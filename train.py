...
def parse_opt(known=False):
    ...
    parser.add_argument("--flipud", type=bool, default=False, help="random horizontal flips")
    parser.add_argument("--fliplr", type=bool, default=False, help="random vertical flips")
    parser.add_argument("--mosaic", type=bool, default=False, help="use mosaic augmentation")
